...
public class TelaMemoria1 extends AppCompatActivity implements View.OnClickListener {
    ...
    private final ImageView[] mCards = new ImageView[8];
    ...
    private RankingDBManager_1 rankingDBManager;
    ...
    private static final long MAX_TIME = 20000 * 1000; // tempo máximo em milissegundos
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rankingDBManager = new RankingDBManager_1(this);
    ...
    private long obterTempoTotalJogado() {
    ...
    private void saveTimeToRanking(List<String> times) {
        for (String time : times) {
            ...
            rankingDBManager.adicionarPontuacao(totalTime);
        }
    }


    private void startTimer() {
        final TextView timerView = findViewById(R.id.timer1);
                ...
                if (millis >= MAX_TIME) {
                    ...
                    new CountDownTimer(5000, 1000) {
                        ...
                        public void onTick(long millisUntilFinished) {
                            Snackbar.make(findViewById(R.id.timer1), "O aplicativo será fechado em " + millisUntilFinished / 1000 + " segundos.", Snackbar.LENGTH_SHORT).show();
                        }
    ...
    private void checkAllCardsMatched() {
        ...
        pauseTimer();
        long tempoTotalJogado = obterTempoTotalJogado();
    }
    private void saveTimeToVariable(String time) {
        completedTime = time;
    }
